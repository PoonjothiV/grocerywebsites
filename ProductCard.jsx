      ...
      <div className="text-gray-500/60 text-sm">
        ...
        <div className="flex items-end justify-between mt-3">
          ...
          <div onClick={(e) => { e.stopPropagation(); }} className="text-primary">
            ...
            {!product.inStock ? (
              <button className="flex items-center justify-center gap-1 bg-gray-400/40 border border-gray-400/60 md:w-[80px] w-[64px] h-[34px] rounded cursor-not-allowed" disabled>
